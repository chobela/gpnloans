...
<div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="box">
            <div class="box-header">
              ...
              <h3 id="response" class="box-title">All Loans</h3>
              ...
              <?php } ?>
                 ...
                 <tfoot class="bg-gray">
                     <tr>
                        ...
                        <th style="text-align:right" rowspan="1" colspan="1"></th>
                         <th style="text-align:right" rowspan="1" colspan="1"></th>
                        <th style="text-align:right" rowspan="1" colspan="1"><?php echo 'k'. $app->sumprincipal();?></th>
                        <th style="text-align:right" rowspan="1" colspan="1"></th>
                        <th style="text-align:center" rowspan="1" colspan="1"><?php echo 'k'. $app->sumdebt();?></th>
                        <th style="text-align:center" class="text-right" rowspan="1" colspan="1"> <?php echo 'k'. $app->totalpaid();?></th>
                        <th style="text-align:center" class="text-right" rowspan="1" colspan="1"><?php echo 'k'. $app->totalbalance();?></th>
