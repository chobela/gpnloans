...
<div class="box-body">
 	 	 ...
 	 	 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="sname" class="form-control" id="sname" required="" value="">
           ...
           <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="scode" class="form-control" id="sode" required="" value="">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="duration" class="form-control" id="duration" required="" value="">
          	 ...
          	 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="minbalance" class="form-control" id="minbalance" required="" value="">
         ...
         <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="interest" class="form-control" id="interest" required="" value="">
                    ...
                    <div class="col-sm-6">
                       ...
                       <textarea class="form-control" rows="3" name="notification">Hello {name}. Congratulations! You have earned {amount} on your account. Keep saving with us.
                       </textarea>
                      
                    </div> 
                </div>
                  <input type="hidden" name="mm_insert" class="form-control" id="mm_insert" value="add_product">

                   <div class="box-footer">
                    <button type="button" class="btn btn-default" onclick="parent.location='loantypes.php'">Back</button>
                    <button type="submit" class="btn btn-warning pull-right submit-button">Submit</button>
                </div><!-- /.box-footer -->
 	 </form>
</div>
<!-- /.box -->
