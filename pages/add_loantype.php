...
<div class="box-body">
 	 	 ...
 	 	 <div class="form-group">
          	 ...
          	 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="days" class="form-control" id="days" required="" value="">
          	 ...
          	 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="minamount" class="form-control" id="minamount" required="" value="">
         ...
         <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="intrate" class="form-control" id="intrate" required="" value="">
        ...
        <div class="panel panel-default"><div class="panel-body bg-gray text-bold">Penalty Settings (Required fields):</div>
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="grace" class="form-control" id="grace" required="" value="">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="intdefault" class="form-control" id="intdefault" required="" value="">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="paybackperiod" class="form-control" id="paybackperiod" required="" value="0">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="msg1" class="form-control" id="msg1" required="" value="7">
                    ...
                    <div class="col-sm-6">
                       ...
                       <textarea class="form-control" rows="3" name="msg2txt">Hello {name}. Please note that your Loan is due today. Please make payment within the next 5 days to avoid penalties.
                       </textarea>
                      
                          <p>Message to be sent out at 09hrs on the due date.</p>
                    </div> 
                </div>
                  <input type="hidden" name="mm_insert" class="form-control" id="mm_insert" value="add_loantype">
